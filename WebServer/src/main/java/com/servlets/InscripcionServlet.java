...
public class InscripcionServlet extends HttpServlet {
     ...
     *
     * @implNote Permite a un turista crear una inscripción en una salida con
     * una actividad específica.
     * @param fecha LocalDate - La fecha de la inscripción.
     * @param cantidad int - La cantidad de inscripciones a crear.
     * @param nombreTurista String - El nombre del turista que realiza la
     * inscripción.
     * @param nombreSalida String - El nombre de la salida a la que se inscribe.
     * @param nombreActividad String - El nombre de la actividad a la que se
     * inscribe.
     * @return JSON - Devuelve un mensaje de éxito o un mensaje de error en
     * formato JSON.
     */
     ...
     *
     * @implNote Permite calcular el costo total de una inscripción en una
     * salida con una actividad específica.
